...
const ListTableName = "seminar_list"
const DetailTableName = "seminar_detail"
const BookTableName = "seminar_book"
const SeminarHistoryTableName = "history_seminar"
...
function getVisitReview(params) {
  return new Promise(function (resolve, reject) {
    db.query("SELECT * FROM " + SeminarHistoryTableName + " WHERE visit_uuid=?", params, function (err, result) {
      if(err) {
        reject(err);
      }
      resolve(result);
...
function insertBooking(params) {
  return new Promise(function (resolve, reject) {
    db.query("insert into "+ SeminarHistoryTableName + " SET ?", params, function (err, result) {
      if(err) {
        reject(err);
      }
      resolve(result);
